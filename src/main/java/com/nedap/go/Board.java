 ...
 * constuctor makes board with String. Returns value of point. Checks if board
 * is full. Changes the board when setPoint method is called. Returns board
 * size. Checks if point is empty.
 * 
