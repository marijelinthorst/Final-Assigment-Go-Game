...
public class GameTest {
	...
	public void setUp() {
		...
		players[0] = new HumanPlayer("Piet", 1, 1);
		players[1] = new HumanPlayer("Klaas", 2, 1);
	...
	public void testcurrentPlayer() {
		assertEquals(game.currentPlayer(), players[0].getColour());
		game.doMove(5, 1);
		assertEquals(game.currentPlayer(), players[1].getColour());
		game.doPass();
		assertEquals(game.currentPlayer(), players[0].getColour());
	}
	...
	@Test
	public void testgetBoardSizeN() {
		assertEquals(game.getBoardSizeN(), 3);
	}
	
	@Test
	public void testgetCurrentBoard() {
		assertEquals(game.getCurrentBoard(), "000000000");
		game.doMove(0, 1);
		assertEquals(game.getCurrentBoard(), "100000000");
	}
